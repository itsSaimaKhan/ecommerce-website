...
const Banfo = () => {
  return (
    ...
    <div>
        ...
        <div className='bg-[#FAF3EA]  h-[260px] w-[1400px] top-100px bottom-100px flex flex-col md:flex-row justify-between items-center p-5 md:p-10 my-5 md:my-10 gap-6 md:gap-0'>
